let keypress,Game;_308‍.w("keypress",[["default",["keypress"],function(v){keypress=v}]]);_308‍.w("./engine/game",[["default",["Game"],function(v){Game=v}]]);
...
game.loadGame(gs); 
_308‍.g.console.log(game.toString());

game.onMove(gameState => {
   _308‍.g.console.log(game.toString());
   _308‍.g.console.log(game.gameState);
});

game.onWin(gameState => {
    _308‍.g.console.log('You won with a gameState of...', gameState)
});

game.onLose(gameState => {
    _308‍.g.console.log('You lost! :(', gameState)
